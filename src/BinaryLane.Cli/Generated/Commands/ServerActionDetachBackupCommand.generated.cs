...
public static class ServerActionDetachBackupCommand
{
    public static Command Create()
    {
        var command = new Command("detach-backup", "Detach any attached backup from a server");
