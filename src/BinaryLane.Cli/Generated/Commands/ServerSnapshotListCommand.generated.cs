...
public static class ServerSnapshotListCommand
{
    public static Command Create()
    {
        var command = new Command("list", "List all snapshots for a server");

        var server_idArg = new Argument<string>("server_id") { Description = "The ID of the server for which snapshots should be listed." };
        ...
        command.SetAction(async (parseResult, ct) =>
        {
            ...
            return await ApiCommandBase.ExecuteApiCallAsync(
                cmdCtx,
                client => ApiCommandBase.ExecutePaginatedAsync(client, $"v2/servers/{server_id}/snapshots"),
                json =>
                {
